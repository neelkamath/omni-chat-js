...
describe('isValidDateTimeScalar()', () => {
  ...
  test('date and time must not be valid', () =>
    expect(() => isValidDateTimeScalar('2021-01-19T11:18:19.:')).toBe(false));
});
...
describe('isValidUuidScalar()', () => {
  test('the scalar must be valid', () =>
    expect(() => isValidUuidScalar('123e4567-e89b-12d3-a456-426614174000')).toBe(true));
