...
import {validateLogin, validateUuidScalar} from '../validators';
...
export class QueriesApi {
     ...
     * @param query Used to case-insensitively queries text messages, poll message title and options, action message
     * text and actions, and pic message captions.
    ...
    async searchChatMessages(
        ...
        const response = await queryOrMutate(this.protocol, this.apiUrl, {
            ...
            `,
            variables: {chatId, query, last: pagination?.last, before: pagination?.before},
        }, accessToken);
